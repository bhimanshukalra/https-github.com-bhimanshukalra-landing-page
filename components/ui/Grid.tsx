  ...
  return (
    <section>
      <div className="md:h-[50vh] pt-4 md:pt-0 px-1 md:px-8 flex items-center justify-center">
        <div className="p-1 md:p-4 border rounded-3xl dark:bg-neutral-900  border-neutral-200 dark:border-neutral-800 mx-auto w-full md:w-3/4 h-3/5 md:h-3/4">
          ...
          <Compare
            firstImage="/before-img.png"
            secondImage="/after-img.png"
